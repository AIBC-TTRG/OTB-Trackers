...
% mtimesx
if exist('/home/aibc/Documents/xiangmu/matlab/COT/external_libs/mtimesx', 'dir') == 7
    disp(123213);
    cd /home/aibc/Documents/xiangmu/matlab/COT/external_libs/mtimesx
    mtimesx_build;
    cd(home_dir)
...
% PDollar toolbox
if exist('/home/aibc/Documents/xiangmu/matlab/COT/external_libs/pdollar_toolbox/external', 'dir') == 7
    cd /home/aibc/Documents/xiangmu/matlab/COT/external_libs/pdollar_toolbox/external
    toolboxCompile;
    cd(home_dir)
else
...
% matconvnet
if exist('/home/aibc/Documents/xiangmu/matlab/COT/external_libs/matconvnet/matlab', 'dir') == 7
    cd /home/aibc/Documents/xiangmu/matlab/COT/external_libs/matconvnet/matlab
    vl_compilenn;
