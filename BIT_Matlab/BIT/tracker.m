function [positions, time] = tracker(video_path, img_files, pos, target_sz, show_visualization, video_name)
    ...
    file = sprintf('/home/linhan/huang/github/BIT/result/%s_BIT.txt',video_name);
