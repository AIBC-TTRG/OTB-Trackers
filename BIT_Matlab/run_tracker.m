...
close all;
gui=1;
base_path = '/home/linhan/huang/OTB/OTB-Person/OTB-50/';
mode = 'choose';
tracker_name ='BIT';
addpath(['/home/linhan/huang/github/' tracker_name]);
...
case 'choose',
    ...
    if ~isempty(video),
        ...
        [positions, time] = tracker(video_path, img_files, pos, target_sz, show_visualization, lower(video));
